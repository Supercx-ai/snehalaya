...
export default function AddToCart({
  ...
  return (
    <button
      ...
      className="h-12 px-8 rounded-md bg-burgundy text-cream text-sm font-medium tracking-wide2 uppercase disabled:opacity-60 flex items-center justify-center gap-2"
    >
