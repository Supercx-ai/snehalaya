...
export default function MaharaniPromo() {
  return (
    <section className="relative h-[598px] overflow-hidden">
      <Image src="/figma/maharani/silk-bg.png" alt="" fill className="object-cover" />
      <Image src="/figma/maharani/photo-mosaic.png" alt="" fill className="object-contain" />

      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
        <h2 className="font-display font-light text-heading-lg text-white">MAHARANI</h2>
        <div className="mt-4 w-[301px] border-t border-accent" />
